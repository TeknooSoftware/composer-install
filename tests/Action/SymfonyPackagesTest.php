...
class SymfonyPackagesTest extends TestCase
{
    ...
    protected function tearDown(): void
    {
        ...
        @\unlink(static::CONFIG_PATH . '/config/packages/string.yaml');
        @\unlink(static::CONFIG_PATH . '/config/packages/array.yaml');
        @\unlink(static::CONFIG_PATH . '/config/packages/base64.yaml');
...
EOF,
    ...
    public function testUninstallWithoutDeletionConfirmation()
    {
        ...
        \mkdir(static::CONFIG_PATH . '/config/packages', 0777, true);
        @\touch(static::CONFIG_PATH . '/config/packages/string.yaml');
        @\touch(static::CONFIG_PATH . '/config/packages/array.yaml');
        @\touch(static::CONFIG_PATH . '/config/packages/base64.yaml');
        ...
        self::assertTrue(
            \file_exists(static::CONFIG_PATH . '/config/packages/string.yaml')
        );

        self::assertTrue(
            \file_exists(static::CONFIG_PATH . '/config/packages/array.yaml')
        );

        self::assertTrue(
            \file_exists(static::CONFIG_PATH . '/config/packages/base64.yaml')
        );
    }
